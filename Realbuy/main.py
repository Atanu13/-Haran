...
app.config['MONGO_URI'] = 'mongodb+srv://nihar:nihar@cluster0.6yxyu.mongodb.net/loginauthen?retryWrites=true&w=majority'
#db connection
mongo = PyMongo(app)
...
def index1(prices, prices1):
    ...
    if request.method == 'POST':
        ...
        print(searchString)
        try:
            #dbConn = pymongo.MongoClient('mongodb+srv://nihar:nihar@cluster0.6yxyu.mongodb.net/products?retryWrites=true&w=majority')
            ...
            if products:  # if there is a collection with searched keyword and it has records in it
                ...
                if session['user'] is not None:
                    print('this')
                    return render_template('result2.html',prices=prices,user=session['user'])
                    #print('this')# show the results to user
                else:
                    print('that')
                    #flash("to add to cart please sign in ")
                return render_template('result2.html',prices=prices)
            else:
                ...
                #                   ProductSpec1 =
                    ...
                    ProductSpec = 'No Specs'
                    ProductSpec1 = 'No Specs'
                ...
                try:
                    ...
                    ProductPrice = 'No Discount'
                    ProductPrice1 = 'No Discount'
